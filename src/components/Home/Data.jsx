  ...
  return (
    <div className="home_data">
      <h1 className="home_title">
        Daniel J. Anyinu
        <svg className="home_hand" id="emoji" width="36" height="36" viewBox="0 0 60 60" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g id="hair"/>
        <g id="skin">
      ...
      <p className="home_description">
        I'm a data analyst and web developer in Abuja, I enjoy making sense out of data, I'm dedicated to creating great work.
      </p>

      <a href="#contact" className="button button-flex">
        Say Hi!
        <i className="uil uil-message" style={{ marginLeft: ".5rem"}}></i>
      </a>
    </div>
  )
}
